...
/**
  ...
  * All rights reserved.
  *------------------------------------------https://doctor-moon.notion.site/4-349b651a925a8009bdbce1a3fcf06975
...
//transmit
enum {
	i2c_start_t = 0, //start bit set
	i2c_ev5_t,       //>> interrupt, I2C_SR1 Read, I2C_DR Write address
	i2c_ev6_t,       //>> interrupt, I2C_SR1 Read, I2C_SR2 Read (addr clear)
	i2c_ev8_t,       //>> TXE interrupt, i2c_DR write
	i2c_ev8_2_t      //>> interrupt,if BTF=1 > I2C_CR1 STOP bit set
};
...
int main(void)
{
  ...
  xTaskCreate(I2C2_Task, "I2C2_Task", 1000,NULL, 10,NULL);
  //xTaskCreate(I2C2_Task, "I2C2_Task", 1000,NULL, 10,NULL);
